...
public class UserFour extends JFrame implements ActionListener, Runnable{
    ...
    UserFour(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("group/chatting/application/icons/logo.png"));
       ...
       JLabel l3 = new JLabel("CSE_BATCH_2018");
    ...
    public void actionPerformed(ActionEvent ae){
        String str = "Wang Fang Fei: "+t1.getText();
        try{
            writer.write(str);
            writer.write("\r\n");
            writer.flush();
